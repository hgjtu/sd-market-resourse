...
class ItemControllerTest {
    ...
    void testAllByUsername() {
        ...
        when(itemService.getAllByUsernameAndType("admin", "sell"))
                .thenReturn(Flux.just(item));

        Flux<ItemMinResponse> result = itemController.allByUsername("admin", "sell");
        ...
        verify(itemService, times(1))
                .getAllByUsernameAndType("admin", "sell");
    }
